...
def main(config, args): 
    ...
    text_prompts, image_paths, _ = validate_and_process_user_prompt(text_prompt, image_path, mode=config.get("mode"))
    ...
    for global_idx, (text_prompt, image_path) in tqdm(enumerate(this_rank_eval_data)):    
